...
function Panorama(settings) {
    ...
    this.init = function () {
        ...
        this.scroller = new IScroll(_.scroller.selector, _.scroller.options);
        this.reflow();
        this.bindEvents();
    ...
    this.setValue = function (value) {
        ...
        ///  _.$container.scrollLeft(rightPos * value);
    ...
    this.getValue = function () {
        var rightPos = this.container.width - this.viewport.width;
        //   var scrollLeft = _.$container.scrollLeft() / rightPos;
        var scrollLeft = Math.abs(self.scroller.x) / rightPos;
        return scrollLeft;
    };
